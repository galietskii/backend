<?php
    $image_promo_mobile = get_field('image_promo_mobile');
    $image_promo = get_field('image_promo');
    ...
    $plus = get_field('plus');
    $minus = get_field('minus');
    $ico_checked = get_field('ico_checked');
    $ico_cancel = get_field('ico_cancel');
?>
 <section class="promo">
          <div class="promo__bg">
            <picture>
              <source media="(max-width: 768px)" srcset="<?php echo esc_url($image_promo_mobile['url']); ?>" />
              <source media="(min-width: 769px)" srcset="<?php echo esc_url($image_promo['url']); ?>" />
              <img src="<?php echo esc_url($image_promo['url']); ?>" alt="" role="presentation" />
            </picture>
          </div>
          <div class="container">
                      ...
                      <div class="input input--text ">
                        ...
                        <div class="input__validation">
                          <div class="input__validation-valid">
                            <img src="<?php echo esc_url($ico_checked['url']); ?>" alt="" role="presentation">
                          </div>
                          <div class="input__validation-invalid">
                            <img src="<?php echo esc_url($ico_cancel['url']); ?>" alt="" role="presentation">
                          </div>
                        </div>
                      ...
                      <div class="input input--number ">
                        ...
                        <div class="input__number">
                          <div class="input__number-btn input__number-minus">
                            <img src="<?php echo esc_url($minus['url']); ?>" alt="-">
                          </div>
                          <div class="input__number-btn input__number-plus">
                            <img src="<?php echo esc_url($plus['url']); ?>" alt="+">
                          </div>
                        </div>
                      </div>
                    </div>
